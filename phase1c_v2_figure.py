...
df = pd.read_csv('/home/claude/phase1c_v2/city_gamma_table.csv')
...
ax.set_title('A. Site-level γ across 34 AIDSVu MSAs, overlaid with LEN-program trial footprint '
             '(Meyer/Kamitani severity parameterization, γ_base = 2×10⁻⁴/day)',
...
plt.suptitle('Phase 1c-v2 — Site-Level Kassanjee Survival-Bias Correction from AIDSVu + Meyer/Kamitani Severity Parameterization',
             fontsize=12, fontweight='bold', y=0.99)

plt.savefig('/home/claude/phase1c_v2/fig_phase1c_v2.png', dpi=200, bbox_inches='tight')
print("Saved: /home/claude/phase1c_v2/fig_phase1c_v2.png")
