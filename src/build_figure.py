...
plt.tight_layout()
plt.savefig(os.path.join(FIG_DIR, 'figure1.pdf'), bbox_inches='tight', dpi=300)
plt.savefig(os.path.join(FIG_DIR, 'figure1.png'), bbox_inches='tight', dpi=300)
print(f"Saved figure1.pdf and figure1.png to {FIG_DIR}")
